...
def get_all_points():
   ...
   url="http://212.29.254.24:18010/cgi-bin/cgi.cgi?WebService"
   headers = {'Content-Type': 'text/xml'}
   headers = {'SOAPAction': 'http://212.29.254.24:18010/cgi-bin/cgi.cgi?WebService=GetSlaveList'}
   ...
   for device in all_devices:
      ...
      try:
         url="http://212.29.254.24:18010/cgi-bin/cgi.cgi?WebService"
         headers = {'Content-Type': 'text/xml'}
         headers = {'SOAPAction': 'http://212.29.254.24:18010/cgi-bin/cgi.cgi?WebService=GetSlave'}
         body = """<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ns="http://www.resourcedm.com/RDMServices/2012/06/18/">
                     <soapenv:Header/>
                     <soapenv:Body>
                        <ns:GetSlave>
...
def check_temps():    
   ...
   # Get the alarms if state = alarm
      ...
      if all_states[i] == "Alarm":
         ...
         url="http://212.29.254.24:18010/cgi-bin/cgi.cgi?WebService"
         headers = {'Content-Type': 'text/xml'}
         headers = {'SOAPAction': 'http://212.29.254.24:18010/cgi-bin/cgi.cgi?WebService=GetAlarmList'}
         body = """<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ns="http://www.resourcedm.com/RDMServices/2012/06/18/">
         <soapenv:Header/>
         <soapenv:Body>
            <ns:GetAlarmList>
...
print (os.path.isfile("osher_ad_rdm_table.db"))
if os.path.isfile("osher_ad_rdm_table.db") == False:
